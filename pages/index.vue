...
<template>
    <div class="min-h-screen flex flex-col items-center justify-start px-4 sm:px-8 lg:px-16">
        ...
        <ArticleList v-if="data?.data" class="mt-10 mb-10 " :posts="data?.data?.data" />
        ...
        <div class="w-full flex justify-center mt-6">
            <TailwindPagination v-if="data?.data" class="mt-4 p-2 bg-white shadow-md rounded-lg w-full sm:w-auto"
                :data="data?.data" @pagination-change-page="paginateData" />
        </div>
